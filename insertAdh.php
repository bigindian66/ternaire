...
if(isset($_POST['submit'])) {
	...
	//$lastIndex renvoie un nombre entre 0 et n, représentant le nombre d'adhésions à la même date
		...
		$lastIndex++;
	//Le numéro d'adhésion est ainsi créé sur le modèke : date(yymmdd)_indice(nn)
	...
	//La première adhésion du même jour portait le numéro 180122_01.
		$adh_num = $adh['num'] = $dateAdh.'_'. str_pad($lastIndex, 2);
		/*if($lastIndex<10){
			$adh_num = $dateAdh.'_0'.$lastIndex;
		}
		else{
			$adh_num = $dateAdh.'_'.$lastIndex;
		}*/
